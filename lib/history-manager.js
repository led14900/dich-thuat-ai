...
class HistoryManager {
  ...
  async addEntry(entryData) {
    ...
    const newEntry = {
      ...
      // So trang GOC cua tung khoi trong markdownContent. Trang loi va trang bi
      // bo qua khong co trong markdown, nen thieu mang nay thi luc tai lai file
      // Word chan trang se danh so sai.
      pageNumbers: Array.isArray(entryData.pageNumbers) ? entryData.pageNumbers : null,
