...
📥 Tải trực tiếp:
- Bản portable không cần cài đặt: [Download AI Translate 1.2.2.exe](https://github.com/led14900/dich-thuat-ai/releases/download/v1.2.2/AI.Translate.1.2.2.exe)
- Bản cài đặt Setup: [Download AI Translate Setup 1.2.2.exe](https://github.com/led14900/dich-thuat-ai/releases/download/v1.2.2/AI.Translate.Setup.1.2.2.exe)
...
## ⚙️ Cách chạy
1. Tải `AI Translate 1.2.2.exe` nếu muốn dùng bản portable, hoặc `AI Translate Setup 1.2.2.exe` nếu muốn cài đặt.
